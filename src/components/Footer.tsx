...
export default function Footer() {
  return (
    <footer className="relative bg-slate-950 text-white font-body overflow-hidden border-t border-slate-800/80">
      {/* Top Accent Line */}
      <div
        aria-hidden="true"
        className="h-1 w-full bg-linear-to-r from-primary via-secondary to-primary"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col justify-between">
            <div>
              <Link href="/" className="inline-block mb-4">
                <Image
                  ...
                  width={140}
                  height={40}
                  className="h-30 w-auto object-contain brightness-200"
                />
              </Link>
            ...
            <div className="mt-8 pt-6 border-t border-slate-800/80">
              <span className="text-xs font-bold tracking-wider text-secondary uppercase block mb-2">
              ...
              <div className="flex items-center gap-2 max-w-sm">
                <input
                  ...
                  className="w-full rounded-xl bg-slate-900 border border-slate-800 px-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                />
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-xl bg-primary px-4 py-2.5 text-xs font-semibold text-white transition-all hover:bg-[#004870]"
          ...
          <div>
            <h4 className="font-heading text-base font-semibold text-white tracking-wide mb-4">
              Navigation
            </h4>
