...
export default function FaqSection() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-slate-50/60 py-20 sm:py-24 lg:py-28 font-body text-slate-900"
    >
      {/* Background radial glows */}
      <div
        aria-hidden="true"
        className="absolute -left-52 top-16 h-128 w-lg rounded-full bg-soft/70 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2
            id="faq-heading"
            className="font-heading text-4xl sm:text-5xl lg:text-6xl font-medium leading-[0.92] tracking-tighter text-slate-950"
          >
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="group flex w-full items-start justify-between gap-6 px-5 py-6 text-left sm:px-7 sm:py-7 cursor-pointer"
                  >
                    <div className="flex items-start gap-4 sm:gap-5">
                      ...
                      <h3
                        className={`font-heading text-xl font-semibold leading-snug transition-colors duration-300 sm:text-2xl ${
                          isActive
                            ? "text-primary"
